						    ...
						    <div class="td-skin-container td-skin-content">
							    <div class="td-demos-list">
								    ...
								    foreach (td_global::$demo_list as $demo_id => $stack_params) {
									    ...
									    ?>
									    <div class="td-set-theme-style"><a target="_blank" href="<?php echo td_global::$demo_list[$demo_id]['demo_url'] ?>" class="td-set-theme-style-link td-popup td-popup-<?php echo $td_demo_names[$stack_params['text']] ?>" data-img-url="http://demo.tagdiv.com/demos_popup/newspaper/large/<?php echo $demo_id; ?>.jpg"></a></div>
								    <?php } ?>
